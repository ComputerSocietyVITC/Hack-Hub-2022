...
function About() {
  ...
  return (
    <section className="pt-12 px-8 sm:px-0" ref={aboutRef} id='aboutContainer'>
      ...
      <section className="p-8 rounded-2xl font-Sansation text-bold text-lg md:text-2xl text-white my-16 sm:mx-24 lg:mx-32 text-center md:leading-loose" style={{ "backgroundColor": "#3e009745" }}>
