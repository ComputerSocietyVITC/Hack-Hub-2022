        ...
        <section>
            <section className="font-Sansation font-bold py-2 grid grid-cols-10 gap-2">
                <div className="col-start-3 col-span-2 ">
                    <div>
                        <p className="uppercase text-white text-xl flex-row flex-wrap mt-4 mb-5">Contact Us</p>
                    </div>
                ...
                <div className="col-start-7 col-span-2">
                    <div>
                        <p className="uppercase text-white text-xl mx-auto mt-3 mb-4 ">Social Media</p>
                    </div>
                    <div>
                        <div className="grid grid-rows-1 grid-flow-col gap-1 ">
                            {(socials.filter((title)=>{
                                return title.header==="Social Links"
                            })[0]).icons.map((im)=>{
                            return(
                                    <Foot key={im.id} src={im.src} Link={im.Link} alt={im.alt}/>
                                )
                            })
                            }
                        </div>
            ...
            <p className="text-white font-Sansation items-left justify-left text-center text-1xl mb-5">©️ IEEE CS VITC</p>
        </section>
    )
}
