            ...
            <div className="h-screen">
                <div className="w-full pt-28 px-10 md:p-28">
                    ...
                    <div className="mt-2 md:mt-6 text-center">
                        <h1 className="text-4xl md:text-7xl font-Atmos mx-auto text-gray-300">2022</h1>
                    </div>
                </div>
                <div className="mt-28 md:px-36 grid grid-cols-1 md:grid-cols-3 gap-10">
                    <div className="mx-auto order-1 md:order-1 md:mx-0 md:ml-auto font-bold bg-gradient-to-r w-80 from-gradViolet to-gradPink py-3 text-xl text-center text-white shadow-xl hover:shadow-md rounded-2xl">
                        <button>REGISTER ON DEVFOLIO</button>
                    </div>
                    <div className="mx-auto order-3 md:order-2 mt-20 md:mt-0">
                    ...
                    <div className="mx-auto order-2 md:order-3 md:mx-0 font-bold bg-gradient-to-r w-80 from-gradViolet to-gradPink py-3 text-xl text-center text-white shadow-xl hover:shadow-md rounded-2xl">
